  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] flex">
        ...
        <div className="p-8">
          ...
          <div className="mb-8">
            ...
            <div className="bg-[#F4F4F5] rounded-[10px] p-3 mb-4 flex items-center">
              ...
              <span className="text-pinterin-purple font-inter text-xl font-medium">My profile</span>
            </div>
      ...
      <div className="flex-1 flex flex-col">
        {/* Header */}
        <div className="flex justify-between items-center bg-white border-b border-[#DEE5ED] px-24 py-8 shadow-sm">
          <div className="flex items-center">
            ...
            <span className="text-pinterin-dark-blue font-dm-sans text-xl font-bold">Pinterin</span>
          </div>
        ...
        <div className="flex-1 p-8">
          <h1 className="text-pinterin-dark-blue font-inter text-2xl font-bold mb-8">My Profile</h1>
          ...
          <div className="flex gap-8">
            ...
            <div className="w-[397px]">
              <div className="bg-white rounded-[10px] shadow-lg p-8">
                ...
                <div className="flex items-center mb-6">
                  <svg width="66" height="66" viewBox="0 0 66 66" fill="none" xmlns="http://www.w3.org/2000/svg" className="mr-4">
                  ...
                  <div>
                    <h2 className="text-pinterin-dark-blue font-roboto text-xl font-medium mb-1">John Doe</h2>
                    <div className="text-[#595C5F] font-roboto text-base">
                ...
                <div className="border-t border-gray-200 pt-6">
                  <h3 className="text-pinterin-dark-blue font-roboto text-base font-medium mb-1">SAT Exam</h3>
                  <p className="text-[#595C5F] font-roboto text-base">You are surrently enrolled in the SAT course</p>
                </div>
              </div>
            </div>
            ...
            <div className="w-[569px]">
              <div className="bg-white rounded-[10px] shadow-lg p-8 h-[352px]">
                <h2 className="text-pinterin-dark-blue font-roboto text-xl font-medium mb-8">My Plan</h2>
                
                <div className="mb-8">
                  <h3 className="text-pinterin-purple font-roboto text-5xl font-medium mb-6">SAT STARTER</h3>
                  
                  <div className="bg-[#F3F3F6] rounded-[7px] p-4 flex justify-between items-center">
                    <span className="text-[#595C5F] font-roboto text-base">
          ...
          <div className="mt-8">
            <div className="bg-white rounded-[10px] shadow-lg p-8">
              <h2 className="text-pinterin-dark-blue font-roboto text-xl font-medium mb-8">Daily resolved</h2>
              
              <div className="relative h-[356px]">
                {/* Y-axis labels */}
                <div className="absolute left-0 top-0 h-full w-20 flex flex-col justify-between text-right">
                  <span className="text-[#718EBF] font-inter text-sm">40</span>
                  <span className="text-[#718EBF] font-inter text-sm">30</span>
                  <span className="text-[#718EBF] font-inter text-sm">20</span>
                  <span className="text-[#718EBF] font-inter text-sm">10</span>
                  <span className="text-[#718EBF] font-inter text-sm">0</span>
                </div>
                ...
                <div className="ml-24 h-full relative">
                  ...
                  <div className="absolute inset-0 flex flex-col justify-between">
                    <div className="border-t-2 border-dashed border-[#DFE5EE]"></div>
                    <div className="border-t-2 border-dashed border-[#DFE5EE]"></div>
                    <div className="border-t-2 border-dashed border-[#DFE5EE]"></div>
                    <div className="border-t-2 border-dashed border-[#DFE5EE]"></div>
                    <div className="border-t-2 border-dashed border-[#DFE5EE]"></div>
                  ...
                  <svg width="603" height="251" viewBox="0 0 604 253" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute top-4 left-0">
                    ...
                    <circle cx="10.189" cy="242.807" r="8.5" fill="white" stroke="#EDA10D" strokeWidth="3"/>
                    <circle cx="129.18" cy="110.087" r="8.5" fill="white" stroke="#EDA10D" strokeWidth="3"/>
                    <circle cx="240.444" cy="166.298" r="8.5" fill="white" stroke="#EDA10D" strokeWidth="3"/>
                    <circle cx="359.436" cy="10.1577" r="8.5" fill="white" stroke="#EDA10D" strokeWidth="3"/>
                    <circle cx="475.336" cy="128.824" r="8.5" fill="white" stroke="#EDA10D" strokeWidth="3"/>
                    <circle cx="594.327" cy="67.9297" r="8.5" fill="white" stroke="#EDA10D" strokeWidth="3"/>
                  </svg>

                  {/* X-axis labels */}
                  <div className="absolute bottom-0 left-0 right-0 flex justify-between text-[#718EBF] font-inter text-sm mt-4 pt-4">
                    <span>monday</span>
                    <span>tuesday</span>
                    <span>wednesday</span>
                    <span>thursday</span>
