      ...
      <main className="px-6 lg:px-24 py-20">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="text-center mb-20">
            <h1 className="text-pinterin-blue font-dm-sans text-4xl lg:text-6xl font-bold leading-tight lg:leading-[76px] mb-10">
              For Partnership
            </h1>
          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-white rounded-[35px] shadow-lg p-16">
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="flex justify-center pt-8">
                  <button
                    type="submit"
                    className="bg-pinterin-dark-blue text-white px-8 py-4 rounded-full font-roboto text-2xl font-normal leading-8 hover:bg-pinterin-purple transition-colors border border-[#0D1E2F]"
                  >
                    Submit
                  </button>
                </div>
